                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: [
                          ...
                          DropdownMenuItem(
                              child: Text('Erwachs.'), value: 'typ2'),
                          DropdownMenuItem(
                              child: Text('Universal'), value: 'typ3'),
                        ],
                        onChanged: (value) {
                          // TODO: Implementieren Sie die Filterlogik für die Sportart
                        },
                    ...
                    DropdownButton<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                            child: Text('Größe 1'), value: 'größe1'),
                        DropdownMenuItem(
                            child: Text('Größe 2'), value: 'größe2'),
                        DropdownMenuItem(
                            child: Text('Größe 3'), value: 'größe3'),
                      ],
                      onChanged: (value) {
                    ...
                    DropdownButton<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                            child: Text('Marke 1'), value: 'marke1'),
                        DropdownMenuItem(
                            child: Text('Marke 2'), value: 'marke2'),
                        DropdownMenuItem(
                            child: Text('Marke 3'), value: 'marke3'),
                      ],
                      onChanged: (value) {
